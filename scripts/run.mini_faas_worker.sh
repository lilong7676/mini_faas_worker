...
docker run --name="mini_faas_worker" -v /root/fakeOSS:/usr/local/mini_faas_worker/packages/gateway/.fakeOSS -d -p 9100:9100 -p 9101:9101 -p 9102:9102 lilong7676/mini_faas_worker:latest
